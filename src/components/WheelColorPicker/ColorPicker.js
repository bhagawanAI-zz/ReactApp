				...
				{ !swatchesOnly && <View style={[ss.wheel]} key={'$1'} onLayout={this.onSquareLayout}>
					{ this.wheelWidth>0 && <View style={[{padding:thumbSize/2,width:this.wheelWidth,height:this.wheelWidth}]}>
						<View style={[ss.wheelWrap]}>
							<Text style={{position:"absolute",left:-width/4,top:-height/25}}>{`
							energy & 
							positivity`}</Text>
							<Text style={{position:"absolute",left : (width*130)/400,top:-height/25}} >{`
							creativity & 
							vision`}</Text>
							<Text style={{position:"absolute",left:-width/4,top:height/5.5}}>{`
							healing &
							immunity`}</Text>
							<Text style={{position:"absolute",left:(width*130)/400,top:height/5.5}}>{`
							relaxation &
							stillness`}</Text>
